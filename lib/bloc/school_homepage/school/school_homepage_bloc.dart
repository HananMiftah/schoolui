    ...
    on<LoadTeachers>((event, emit) async {
      ...
      try {
        final teachersResponse =
            await homepageRepository.getTeachers();
    ...
    on<LoadStudents>((event, emit) async {
      ...
      try {
        final studentsResponse =
            await homepageRepository.getStudents();
    ...
    on<LoadGrades>((event, emit) async {
      ...
      try {
        final gradesResponse =
            await homepageRepository.getGrades();
    ...
    on<LoadSections>((event, emit) async {
      ...
      try {
        final sectionsResponse =
            await homepageRepository.getSections();
    ...
    on<LoadSubjects>((event, emit) async {
      ...
      try {
        final subjectsResponse  =
            await homepageRepository.getSubjects();
